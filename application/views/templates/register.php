...
<body>
    ...
    <div class="site-section">
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-7">
                    <h2 class="heading-21921">Login/Register</h2>
                    ...
                    <div class="bg-light p-4">
                        <form action="login" method="post">
                            ...
                            <div class="input-group form-group">
                                ...
                                <input type="email" class="form-control pl-0 border-left-0" placeholder="Email" aria-label="Password" name="email" required aria-describedby="basic-addon1">
                            </div>
                            ...
                            <div class="input-group form-group">
                                ...
                                <input type="password" class="form-control pl-0 border-left-0" placeholder="Password" aria-label="Password" name="password" required aria-describedby="basic-addon1">
                            </div>
